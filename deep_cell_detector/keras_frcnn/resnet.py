...
'''
#-----------------note by wwk---------line159-162 channel is 1,line 228 nb_classes=2
...
def get_img_output_length(width, height):#-----note wwk---- when stride in conv_block change, this function should also be changed
